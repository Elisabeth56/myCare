...
const Footer = () => {
  return (
    <>
      <footer className="border-t border-stroke bg-card">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-10 mt-5">
                  myCare is a fully functional demo built to production standards.
                </p>
                  ...
                  <form action="#">
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-full border border-stroke px-6 py-3 shadow-solid-11 bg-card text-card-foreground focus:border-primary focus:outline-hidden"
                      />
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} myCare. All rights reserved
              </p>
            </motion.div>
