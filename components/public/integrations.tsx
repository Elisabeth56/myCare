  ...
  return (
    <>
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              ...
              description: `myCare can integrate with external EMR systems to sync patient data, visit history, and clinical notes, reducing duplicate data entry and improving continuity of care.`,
            }}
          />
        ...
        <div className="pattern-dots pattern-blue-500 pattern-bg-white pattern-size-4 pattern-opacity-10 relative mx-auto mt-15 max-w-c-1154 px-4 md:px-8 xl:mt-20 xl:px-0">
          ...
          <div className="flex flex-wrap justify-around gap-y-10">
            ...
            <motion.div
              ...
              className="animate_top w-1/6"
            >
              <div className="inline-block rounded-[10px] bg-white p-4 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
